    ...
    return (
        <>
            ...
            <Tabs defaultValue="all" className="w-full">
                ...
                <div className="px-4">
                    <TabsContent value="all"><DataTable donations={donations} /></TabsContent>
                    <TabsContent value="approved"><DataTable donations={donations.filter((item: donation) => item.isApproved === true)} /></TabsContent>
                    <TabsContent value="pending"><DataTable donations={donations.filter((item: donation) => item.isApproved === false)} /></TabsContent>
                </div>
            </Tabs>
